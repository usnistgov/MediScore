...
python2 MaskScorer.py -t manipulation --refDir ../../data/test_suite/maskScorerTests -r reference/manipulation/NC2016-manipulation-ref.csv -x indexes/NC2016-manipulation-index.csv -s ../../data/test_suite/maskScorerTests/B_NC2016_Manipulation_ImgOnly_c-me2_1/B_NC2016_Manipulation_ImgOnly_c-me2_1.csv -oR ../../data/test_suite/maskScorerTests/maniptest -html
python2 MaskScorer.py -t manipulation --refDir ../../data/test_suite/maskScorerTests -r reference/manipulation/NC2017-manipulation-ref.csv -x indexes/NC2017-manipulation-index.csv -s ../../data/test_suite/maskScorerTests/B_NC2017_Manipulation_ImgOnly_c-me2_1/B_NC2017_Manipulation_ImgOnly_c-me2_1.csv -oR ../../data/test_suite/maskScorerTests/threstest -html
...
if ([ ! -f comp_maskreport_splice.txt -o ! -f comp_maskreport_manip.txt \
...
if test "`eval $filter_t`" = "" ; then
  flag_t=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/threstest/B_NC2016_Manipulation_ImgOnly_c-me2_1-mask_score.csv
	fi
...
if test "`eval $filter_tpi`" = "" ; then
  flag_tpi=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/threstest/B_NC2016_Manipulation_ImgOnly_c-me2_1-mask_scores_perimage.csv
	fi
...
if test "`eval $filter_tjr`" = "" ; then
  flag_tjr=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/threstest/B_NC2016_Manipulation_ImgOnly_c-me2_1-journalResults.csv
	fi
