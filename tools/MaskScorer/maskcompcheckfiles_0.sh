...
python2 MaskScorer.py -t splice --refDir ../../data/test_suite/maskScorerTests -r reference/splice/NC2017-splice-ref.csv -x indexes/NC2017-splice-index.csv --sysDir ../../data/test_suite/maskScorerTests -s C_NC2017_Splice_ImgOnly_p-me_1/C_NC2017_Splice_ImgOnly_p-me_1.csv -oR ../../data/test_suite/maskScorerTests/splicebin -xF --optOut -p 6 -html --outMeta --outAllmeta --color --sbin 200
