...
python2 MaskScorer.py -t splice --refDir ../../data/test_suite/maskScorerTests -r reference/splice/NC2017-splice-ref.csv -x indexes/NC2017-splice-index.csv -s ../../data/test_suite/maskScorerTests/B_NC2017_Splice_ImgOnly_p-me_1/B_NC2017_Splice_ImgOnly_p-me_1.csv -oR ../../data/test_suite/maskScorerTests/splicetest -html --optOut -p $procs --color --speedup
python2 MaskScorer.py -t manipulation --refDir ../../data/test_suite/maskScorerTests -r reference/manipulation/NC2016-manipulation-ref.csv -x indexes/NC2016-manipulation-index.csv -s ../../data/test_suite/maskScorerTests/B_NC2016_Manipulation_ImgOnly_c-me2_1/B_NC2016_Manipulation_ImgOnly_c-me2_1.csv -oR ../../data/test_suite/maskScorerTests/maniptest -p $procs --color --speedup
python2 MaskScorer.py -t manipulation --refDir ../../data/test_suite/maskScorerTests -r reference/manipulation/NC2017-manipulation-ref.csv -x indexes/NC2017-manipulation-index.csv -s ../../data/test_suite/maskScorerTests/B_NC2017_Manipulation_ImgOnly_c-me2_1/B_NC2017_Manipulation_ImgOnly_c-me2_1.csv -oR ../../data/test_suite/maskScorerTests/threstest -html --sbin 128 -p $procs --color --speedup
...
python2 MaskScorer.py -t splice --refDir ../../data/test_suite/maskScorerTests -r reference/splice/NC2017-splice-ref.csv -x indexes/NC2017-splice-index.csv --sysDir ../../data/test_suite/maskScorerTests -s C_NC2017_Splice_ImgOnly_p-me_1/C_NC2017_Splice_ImgOnly_p-me_1.csv -oR ../../data/test_suite/maskScorerTests/splicebin -xF --optOut -p 6 -html --outMeta --outAllmeta --color --sbin 200 --speedup
...
diff ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-mask_score.csv ../../data/test_suite/maskScorerTests/compcheckfiles/ref_maskreport_splicebin.csv > comp_maskreport_splicebin.txt
diff ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-mask_scores_perimage.csv ../../data/test_suite/maskScorerTests/compcheckfiles/ref_maskreport_splicebin-perimage.csv > comp_maskreport_splicebin-perimage.txt
diff ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-journalResults.csv ../../data/test_suite/maskScorerTests/compcheckfiles/ref_maskreport_splicebin-journalResults.csv > comp_maskreport_splicebin-journalResults.txt
...
if test "`eval $filter_sb`" = "" ; then
  flag_sb=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-mask_score.csv
	fi
...
if test "`eval $filter_sbpi`" = "" ; then
  flag_sbpi=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-mask_scores_perimage.csv
	fi
...
if test "`eval $filter_sbjr`" = "" ; then
  flag_sbjr=0
	if [ $clean = "TRUE" ] ; then
		rm ../../data/test_suite/maskScorerTests/splicebin/C_NC2017_Splice_ImgOnly_p-me_1-journalResults.csv
	fi
