...
run_test test_1_0_undirect "$testsuite_directory/checkfiles/test_1_0_undirect"
...
run_test test_2_1_undirect "$testsuite_directory/checkfiles/test_2_1_undirect"
...
run_test filtering_test_0_b "$testsuite_directory/checkfiles/filtering_test_0_b"
run_test filtering_test_1_b "$testsuite_directory/checkfiles/filtering_test_1_b"
run_test filtering_test_2_b "$testsuite_directory/checkfiles/filtering_test_2_b"
