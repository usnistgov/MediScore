...
-------
  ...
  Apr 26, 2018 - MediScore Version 1.3.5
    ...
    * Validator:
      - Updated validator behavior to generate revised output with "FailedValidation" status where dimensional discrepancies arise.
    * Localization Scorer
      - Updated localization scorer to treat "FailedValidation" status as generated by the Validator. Scoring will be with a blank mask of the
        dimensions reported in the index file.
